...
execute as @r at @s as @e[type=item,distance=..6,nbt={OnGround:1b,Item:{id:"minecraft:feather",Count:16b}}] at @s run tag @s add drop_feather_silk_touch_1
execute as @r at @s as @e[type=item,distance=..6,nbt={OnGround:1b,Item:{id:"minecraft:lapis_lazuli",Count:4b}}] at @s run tag @s add drop_lapis_lazuli_silk_touch_1
...
execute as @e[tag=drop_feather_silk_touch_1] at @s if entity @e[tag=drop_lapis_lazuli_silk_touch_1,distance=..1] run tag @s add drop_enchanted_book_silk_touch_1
