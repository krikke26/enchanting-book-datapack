...
execute as @r at @s as @e[type=item,distance=..6,nbt={OnGround:1b,Item:{id:"minecraft:slime_ball",Count:16b}}] at @s run tag @s add drop_slime_ball_binding_curse_1
...
execute as @e[tag=drop_slime_ball_binding_curse_1] at @s if entity @e[tag=drop_lapis_lazuli_binding_curse_1,distance=..1] run tag @s add drop_enchanted_book_binding_curse_1
