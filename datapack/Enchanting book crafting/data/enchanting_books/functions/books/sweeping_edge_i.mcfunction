...
execute as @r at @s as @e[type=item,distance=..6,nbt={OnGround:1b,Item:{id:"minecraft:emerald",Count:8b}}] at @s run tag @s add drop_emerald_sweeping_1
...
execute as @e[tag=drop_emerald_sweeping_1] at @s if entity @e[tag=drop_lapis_lazuli_sweeping_1,distance=..1] run tag @s add drop_enchanted_book_sweeping_1
