...
execute as @e[type=item,tag=craft_event_frost_walker_1] at @s run kill @e[tag=drop_enchanted_book_frost_walker_1,distance=..1,limit=1]
execute as @e[type=item,tag=craft_event_frost_walker_1] at @s run playsound minecraft:entity.experience_orb.pickup master @a
execute as @e[type=item,tag=craft_event_frost_walker_1] at @s run data merge entity @s {Motion:[0.0,0.3,0.0],Tags:[],Item:{id:"minecraft:enchanted_book",Count:1b,tag:{StoredEnchantments:[{id:"minecraft:frost_walker",lvl:1}]}}}
